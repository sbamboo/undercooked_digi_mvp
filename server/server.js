        ...
        try {
            ...
            if (parsedData.event === "connect") {
                ...
                if (parsedData.reqname) {
                    log(`Connect event received with requested name "${parsedData.reqname}" from ${senderIp}. (pid:${playerid},clientFormat:${parsedData.format})`, "route",1);
                } else {
                    log(`Connect event received without name from ${senderIp}. (pid:${playerid},clientFormat:${parsedData.format})`, "route",1);
                }
